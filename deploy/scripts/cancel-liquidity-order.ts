...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  console.log(`Cancel Liquidity Order...`);
  await (
    await liquidityHandler.cancelLiquidityOrder(orderIndex, {
      gasLimit: 200000000,
    })
  ).wait();
  console.log("Cancel Liquidity Order Success!");
};

export default func;
func.tags = ["CancelLiquidityOrder"];
