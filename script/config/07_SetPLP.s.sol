...
contract SetPLP is ConfigJsonRepo {
  ...
  function _setupAcceptedToken() private {
    ...
    _plpTokenConfig[0] = _getPLPTokenConfigStruct(2e17, 0, 1e6, true);
    _plpTokenConfig[1] = _getPLPTokenConfigStruct(2e17, 0, 1e6, true);
    _plpTokenConfig[2] = _getPLPTokenConfigStruct(1e17, 0, 1e6, true);
    _plpTokenConfig[3] = _getPLPTokenConfigStruct(3e17, 0, 1e6, true);
    _plpTokenConfig[4] = _getPLPTokenConfigStruct(2e17, 0, 1e6, true);
