...
async function main(chainId: number) {
  ...
  console.log(`[configs/RebalanceHLPv2Service] setGmxV2DepositHandler`);
  ...
  await ownerWrapper.authExec(
    ...
    rebalanceHLPv2Service.interface.encodeFunctionData("setGmxV2DepositHandler", [config.vendors.gmxV2.depositHandler])
  );
