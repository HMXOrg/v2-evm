...
async function main(chainId: number) {
  ...
  console.log(`[configs/RebalanceHLPv2Service] setGmxV2DepositVault`);
  ...
  await ownerWrapper.authExec(
    ...
    rebalanceHLPv2Service.interface.encodeFunctionData("setGmxV2DepositVault", [config.vendors.gmxV2.depositVault])
  );
