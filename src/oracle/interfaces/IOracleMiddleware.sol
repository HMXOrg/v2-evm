...
interface IOracleMiddleware {
  ...
  function assetPriceConfigs(bytes32 _assetId) external returns (uint256, uint32);
  ...
  function setAssetPriceConfig(bytes32 _assetId, uint32 _confidenceThresholdE6, uint256 _trustPriceAge) external;
}
