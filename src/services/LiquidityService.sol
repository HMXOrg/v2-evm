...
contract LiquidityService is ILiquidityService {
  ...
  */
  ...
  function _joinPool(
    ...
    IVaultStorage(vaultStorage).addPLPLiquidityUSDE30(_token, tokenValueUSDAfterFee);
    IVaultStorage(vaultStorage).addPLPTotalLiquidityUSDE30(tokenValueUSDAfterFee);
