...
contract TradeService is ITradeService {
  ...
  function increasePosition(
...

    {
      ...
      uint256 _changedOpenInterest = (_absSizeDelta * (10 ** _marketConfig.exponent)) / vars.priceE30; // @todo - use decimal asset
      ...
      if (vars.isLong) {
        uint256 _nextAvgPrice = _globalMarket.longPositionSize == 0
          ? vars.priceE30
          : _calcualteLongAveragePrice(_globalMarket, vars.priceE30, _sizeDelta, 0);
