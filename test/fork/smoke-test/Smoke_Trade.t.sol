...
contract Smoke_Trade is Smoke_Base {
    ...
    IERC20 internal constant usdc_e = IERC20(address(ForkEnv.usdc_e));
    ...
    function _createAndExecuteMarketBuyOrder() internal {
        ...
        assertEq(perpStorage.getNumberOfSubAccountPosition(subAccount), 5, "User must have 5 Long position");
