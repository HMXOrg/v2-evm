  ...
  function test_correctness_HLP_disableDynamicFee() external {
    ...
    // HLP LIQUIDITY 99.7 WBTC, 99_700 usdc
    {
      ...
      */
      ...
      assertApproxEqRel(hlpValueBefore, 2093700000000000000000000000000000000, MAX_DIFF, "HLP TVL Before Feed Price");
    ...
    //  ASSERT AFTER T2
    {
      /*
      AFTER T2
      HLP VALUE = 2193400000000000000000000000000000000
      assetIds	value
      usdc	  99700000000000000000000000000000000 (1 * 99700)
      usdt	  0
      dai	    0
      ...
      */
      ...
      assertApproxEqRel(hlpValueAfter, 2193400000000000000000000000000000000, MAX_DIFF, "HLP TVL After T2");
    ...
    // ASSERT AFTER T3
    {
      ...
      */
      ...
      assertApproxEqRel(hlpValueAfter, 2193400000000000000000000000000000000, MAX_DIFF, "HLP TVL After Feed Price T3");
      assertApproxEqRel(
...

    {
      ...
      HLP VALUE (HLP TVL) = 2298085000000000000000000000000000000
      assetIds	value
      usdc	  99700000000000000000000000000000000 (1* 99700)
      usdt	  0
      dai	    0
      ...
      Pending Borrowing Fee =  14204435432108400000000000000 (hlpTVL is changed)
...

    {
      ...
      HLP VALUE (HLP TVL) = 1984030000000000000000000000000000000
      assetIds	value
      usdc	  99700000000000000000000000000000000 (1* 99700)
      usdt	  0
      dai	    0
      ...
      */
      ...
      assertApproxEqRel(hlpValueAfter, 1984030000000000000000000000000000000, MAX_DIFF, "HLP TVL After T5");
      assertApproxEqRel(
        pendingBorrowingFeeAfter,
