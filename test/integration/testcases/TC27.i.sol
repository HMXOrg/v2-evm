...
contract TC27 is BaseIntTest_WithActions {
  function test_correctness_PLP_disableDynamicFee() external {
    ...
    //  ASSERT AFTER T2
    {
      /*
      AFTER T2
      PLP VALUE = 2193242311526886000000000000000000000
      assetIds	value
      usdc	  99700000000000000000000000000000000 (1 * 99700)
      usdt	  0
      dai	    0
      ...
      */
      ...
      assertApproxEqRel(plpValueAfter, 2193242311526886000000000000000000000, MAX_DIFF, "PLP TVL After T2");
...

    {
      ...
      PLP VALUE (PLP TVL) = 2297919427103230300000000000000000000
      assetIds	value
      usdc	  99700000000000000000000000000000000 (1* 99700)
      usdt	  0
      dai	    0
      ...
      Pending Borrowing Fee =  14205458909903400000000000000 (plpTVL is changed)
...

    {
      ...
      PLP VALUE (PLP TVL) = 1983998090613408400000000000000000000
      assetIds	value
      usdc	  99700000000000000000000000000000000 (1* 99700)
      usdt	  0
      dai	    0
      ...
      */
      ...
      assertApproxEqRel(plpValueAfter, 1983998090613408400000000000000000000, MAX_DIFF, "PLP TVL After T5");
      assertApproxEqRel(
        pendingBorrowingFeeAfter,
