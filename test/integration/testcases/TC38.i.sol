...
contract TC38 is BaseIntTest_WithActions {
  ...
  function testCorrectness_TC38() external {
    ...
    // T1: Alice buy long JPYUSD 100,000 USD at 0.008 USD
    {
      ...
      marketSell(ALICE, 0, wbtcMarketIndex, 145_000 * 1e30, address(wbtc), updatePriceData);
...

    {
      ...
      // marketBuy(ALICE, 0, wbtcMarketIndex, 145_000 * 1e30, address(wbtc), updatePriceData);
    }
