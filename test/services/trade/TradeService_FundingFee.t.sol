...
contract TradeService_FundingFee is TradeService_Base {
  ...
  function testCorrectness_fundingFee() external {
    ...
    vm.warp(21001);
    {
      ...
      assertApproxEqRel(_market.currentFundingRate, -0.0060763888888888 * 1e18, 0.000001 ether);
    ...
    vm.warp(31001);
    {
      ...
      assertApproxEqRel(_market.currentFundingRate, -0.007523148148148149 * 1e18, 0.000001 ether);

      assertEq(_market.longPositionSize, 2_000_000 * 1e30);
      assertEq(_market.shortPositionSize, 2_000_000 * 1e30);
      assertEq(_market.longPositionSize - _market.shortPositionSize, 0);
      assertApproxEqRel(_market.fundingAccrued, -0.001525460283779150 * 1e18, 0.0001 ether);
