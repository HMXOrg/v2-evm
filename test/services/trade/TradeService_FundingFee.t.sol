...
contract TradeService_FudningFee is TradeService_Base {
  ...
  //     assertEq(vaultStorage.tradingFee(address(usdt)), 0);
  ...
  //     // 0.81 * 85% = 0.6885
  //     assertEq(vaultStorage.tradingFee(address(usdt)), 0.6885 * 1e6);
  //     // 0.81 * 15% = 0.1215
  ...
  //     assertEq(vaultStorage.tradingFee(address(usdt)), 8.5 * 1e6);
  ...
  //   vm.warp(120);
  //   {
  //     tradeService.decreasePosition(BOB, 0, ethMarketIndex, 500_000 * 1e30);
  //     IPerpStorage.GlobalAssetClass memory _globalAssetClass = perpStorage.getGlobalAssetClassByIndex(0);
  ...
  //     assertEq(vaultStorage.tradingFee(address(usdt)), 12.75 * 1e6);
  ...
  function testCorrectness_borrowingFee() external {
    ...
    vm.warp(110);
    {
      ...
      assertEq(vaultStorage.tradingFee(address(weth)), 0.0064546875 * 1e18);
    ...
    vm.warp(150);
    {
      ...
      assertEq(vaultStorage.tradingFee(address(weth)), 0.0085 * 1e18);
      // 0.002025 * 85% = 0.00172125
      assertEq(vaultStorage.tradingFee(address(wbtc)), 0.00172125 * 1e8);
      // 100 * 85% = 85
      assertEq(vaultStorage.tradingFee(address(usdt)), 85 * 1e6);
