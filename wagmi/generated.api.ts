// Generated by @wagmi/cli@0.1.14 on 4/10/2023 at 2:16:38 PM
import {
  getContract,
  GetContractArgs,
  readContract,
...
export const pythAdapterABI = [
  ...
  },
  {
    ...
    inputs: [],
    name: "pyth",
    outputs: [{ name: "", internalType: "contract ILeanPyth", type: "address" }],
  },
  {
    stateMutability: "nonpayable",
    type: "function",
...
/**
 * Wraps __{@link writeContract}__ with `abi` set to __{@link oracleMiddlewareABI}__.
 */
export function writeOracleMiddleware<TFunctionName extends string>(
  config:
    | Omit<WriteContractPreparedArgs<typeof oracleMiddlewareABI, TFunctionName>, "abi">
    | Omit<WriteContractUnpreparedArgs<typeof oracleMiddlewareABI, TFunctionName>, "abi">,
) {
  return writeContract({ abi: oracleMiddlewareABI, ...config } as WriteContractArgs<
...
/**
 * Wraps __{@link prepareWriteContract}__ with `abi` set to __{@link oracleMiddlewareABI}__.
 */
export function prepareWriteOracleMiddleware<
  TAbi extends readonly unknown[] = typeof oracleMiddlewareABI,
  TFunctionName extends string = string,
>(config: Omit<PrepareWriteContractConfig<TAbi, TFunctionName>, "abi">) {
  return prepareWriteContract({ abi: oracleMiddlewareABI, ...config } as unknown as PrepareWriteContractConfig<
    TAbi,
    TFunctionName
  >)
}
...
/**
 * Wraps __{@link writeContract}__ with `abi` set to __{@link pythAdapterABI}__.
 */
export function writePythAdapter<TFunctionName extends string>(
  config:
    | Omit<WriteContractPreparedArgs<typeof pythAdapterABI, TFunctionName>, "abi">
    | Omit<WriteContractUnpreparedArgs<typeof pythAdapterABI, TFunctionName>, "abi">,
) {
  return writeContract({ abi: pythAdapterABI, ...config } as WriteContractArgs<typeof pythAdapterABI, TFunctionName>)
}

/**
 * Wraps __{@link prepareWriteContract}__ with `abi` set to __{@link pythAdapterABI}__.
 */
export function prepareWritePythAdapter<
  TAbi extends readonly unknown[] = typeof pythAdapterABI,
  TFunctionName extends string = string,
>(config: Omit<PrepareWriteContractConfig<TAbi, TFunctionName>, "abi">) {
  return prepareWriteContract({ abi: pythAdapterABI, ...config } as unknown as PrepareWriteContractConfig<
    TAbi,
    TFunctionName
  >)
}
