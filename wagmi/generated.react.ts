// Generated by @wagmi/cli@0.1.14 on 5/30/2023 at 2:16:06 PM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oracleMiddlewareABI}__ and `functionName` set to `"pyth"`.
 */
export function useOracleMiddlewarePyth<TSelectData = ReadContractResult<typeof oracleMiddlewareABI, "pyth">>(
  config: Omit<
    UseContractReadConfig<typeof oracleMiddlewareABI, "pyth", TSelectData>,
    "abi" | "functionName"
  > = {} as any,
) {
  return useContractRead({ abi: oracleMiddlewareABI, functionName: "pyth", ...config } as UseContractReadConfig<
    typeof oracleMiddlewareABI,
    "pyth",
    TSelectData
  >)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oracleMiddlewareABI}__ and `functionName` set to `"setPyth"`.
 */
export function useOracleMiddlewareSetPyth<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof oracleMiddlewareABI, "setPyth">["abi"],
        "setPyth"
      > & { functionName?: "setPyth" }
    : UseContractWriteConfig<TMode, typeof oracleMiddlewareABI, "setPyth"> & {
        abi?: never
        functionName?: "setPyth"
      } = {} as any,
) {
  return useContractWrite<TMode, typeof oracleMiddlewareABI, "setPyth">({
    abi: oracleMiddlewareABI,
    functionName: "setPyth",
    ...config,
  } as any)
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oracleMiddlewareABI}__ and `functionName` set to `"setPyth"`.
 */
export function usePrepareOracleMiddlewareSetPyth(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oracleMiddlewareABI, "setPyth">,
    "abi" | "functionName"
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: "setPyth",
    ...config,
  } as UsePrepareContractWriteConfig<typeof oracleMiddlewareABI, "setPyth">)
}
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link oracleMiddlewareABI}__ and `eventName` set to `"LogSetPyth"`.
 */
export function useOracleMiddlewareLogSetPythEvent(
  config: Omit<UseContractEventConfig<typeof oracleMiddlewareABI, "LogSetPyth">, "abi" | "eventName"> = {} as any,
) {
  return useContractEvent({ abi: oracleMiddlewareABI, eventName: "LogSetPyth", ...config } as UseContractEventConfig<
    typeof oracleMiddlewareABI,
    "LogSetPyth"
  >)
}
