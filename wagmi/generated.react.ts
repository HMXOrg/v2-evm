<<<<<<< HEAD
// Generated by @wagmi/cli@0.1.14 on 6/27/2023 at 1:44:30 PM
=======
// Generated by @wagmi/cli@0.1.14 on 6/27/2023 at 1:56:11 PM
>>>>>>> feat/limit-order-will-not-revert-in-batch-execute
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link limitTradeHandlerABI}__ and `eventName` set to `"LogExecuteLimitOrderFail"`.
 */
export function useLimitTradeHandlerLogExecuteLimitOrderFailEvent(
  config: Omit<
    UseContractEventConfig<typeof limitTradeHandlerABI, "LogExecuteLimitOrderFail">,
    "abi" | "eventName"
  > = {} as any,
) {
  return useContractEvent({
    abi: limitTradeHandlerABI,
    eventName: "LogExecuteLimitOrderFail",
    ...config,
  } as UseContractEventConfig<typeof limitTradeHandlerABI, "LogExecuteLimitOrderFail">)
}
