// Generated by @wagmi/cli@0.1.14 on 6/13/2023 at 11:27:13 AM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
export const ecoPythCalldataBuilderABI = [
  {
    stateMutability: "nonpayable",
    type: "constructor",
    inputs: [{ name: "ecoPyth_", internalType: "contract IEcoPyth", type: "address" }],
  },
  {
    stateMutability: "view",
    type: "function",
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link botHandlerABI}__ and `functionName` set to `"closeDelistedMarketPositions"`.
 */
export function useBotHandlerCloseDelistedMarketPositions<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof botHandlerABI, "closeDelistedMarketPositions">["abi"],
        "closeDelistedMarketPositions"
      > & { functionName?: "closeDelistedMarketPositions" }
    : UseContractWriteConfig<TMode, typeof botHandlerABI, "closeDelistedMarketPositions"> & {
        abi?: never
        functionName?: "closeDelistedMarketPositions"
      } = {} as any,
) {
  return useContractWrite<TMode, typeof botHandlerABI, "closeDelistedMarketPositions">({
    abi: botHandlerABI,
    functionName: "closeDelistedMarketPositions",
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link botHandlerABI}__ and `functionName` set to `"deleverages"`.
 */
export function useBotHandlerDeleverages<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof botHandlerABI, "deleverages">["abi"],
        "deleverages"
      > & { functionName?: "deleverages" }
    : UseContractWriteConfig<TMode, typeof botHandlerABI, "deleverages"> & {
        abi?: never
        functionName?: "deleverages"
      } = {} as any,
) {
  return useContractWrite<TMode, typeof botHandlerABI, "deleverages">({
    abi: botHandlerABI,
    functionName: "deleverages",
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link botHandlerABI}__ and `functionName` set to `"initialize"`.
 */
export function useBotHandlerInitialize<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof botHandlerABI, "initialize">["abi"],
        "initialize"
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link botHandlerABI}__ and `functionName` set to `"injectTokenToHlpLiquidity"`.
 */
export function useBotHandlerInjectTokenToHlpLiquidity<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof botHandlerABI, "injectTokenToHlpLiquidity">["abi"],
        "injectTokenToHlpLiquidity"
      > & { functionName?: "injectTokenToHlpLiquidity" }
    : UseContractWriteConfig<TMode, typeof botHandlerABI, "injectTokenToHlpLiquidity"> & {
        abi?: never
        functionName?: "injectTokenToHlpLiquidity"
      } = {} as any,
) {
  return useContractWrite<TMode, typeof botHandlerABI, "injectTokenToHlpLiquidity">({
    abi: botHandlerABI,
    functionName: "injectTokenToHlpLiquidity",
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link botHandlerABI}__ and `functionName` set to `"renounceOwnership"`.
 */
export function useBotHandlerRenounceOwnership<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof botHandlerABI, "renounceOwnership">["abi"],
        "renounceOwnership"
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link botHandlerABI}__ and `functionName` set to `"setMultipleMarketStatus"`.
 */
export function useBotHandlerSetMultipleMarketStatus<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof botHandlerABI, "setMultipleMarketStatus">["abi"],
        "setMultipleMarketStatus"
      > & { functionName?: "setMultipleMarketStatus" }
    : UseContractWriteConfig<TMode, typeof botHandlerABI, "setMultipleMarketStatus"> & {
        abi?: never
        functionName?: "setMultipleMarketStatus"
      } = {} as any,
) {
  return useContractWrite<TMode, typeof botHandlerABI, "setMultipleMarketStatus">({
    abi: botHandlerABI,
    functionName: "setMultipleMarketStatus",
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link botHandlerABI}__ and `functionName` set to `"updateDynamicEnabled"`.
 */
export function useBotHandlerUpdateDynamicEnabled<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof botHandlerABI, "updateDynamicEnabled">["abi"],
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link botHandlerABI}__ and `functionName` set to `"updateLiquidityEnabled"`.
 */
export function useBotHandlerUpdateLiquidityEnabled<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof botHandlerABI, "updateLiquidityEnabled">["abi"],
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link botHandlerABI}__ and `functionName` set to `"withdrawFundingFeeSurplus"`.
 */
export function useBotHandlerWithdrawFundingFeeSurplus<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof botHandlerABI, "withdrawFundingFeeSurplus">["abi"],
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link botHandlerABI}__ and `functionName` set to `"closeDelistedMarketPositions"`.
 */
export function usePrepareBotHandlerCloseDelistedMarketPositions(
  config: Omit<
    UsePrepareContractWriteConfig<typeof botHandlerABI, "closeDelistedMarketPositions">,
    "abi" | "functionName"
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: "closeDelistedMarketPositions",
    ...config,
  } as UsePrepareContractWriteConfig<typeof botHandlerABI, "closeDelistedMarketPositions">)
}
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link botHandlerABI}__ and `functionName` set to `"deleverages"`.
 */
export function usePrepareBotHandlerDeleverages(
  config: Omit<UsePrepareContractWriteConfig<typeof botHandlerABI, "deleverages">, "abi" | "functionName"> = {} as any,
) {
  return usePrepareContractWrite({
    abi: botHandlerABI,
    functionName: "deleverages",
    ...config,
  } as UsePrepareContractWriteConfig<typeof botHandlerABI, "deleverages">)
}
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link botHandlerABI}__ and `functionName` set to `"injectTokenToHlpLiquidity"`.
 */
export function usePrepareBotHandlerInjectTokenToHlpLiquidity(
  config: Omit<
    UsePrepareContractWriteConfig<typeof botHandlerABI, "injectTokenToHlpLiquidity">,
    "abi" | "functionName"
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: "injectTokenToHlpLiquidity",
    ...config,
  } as UsePrepareContractWriteConfig<typeof botHandlerABI, "injectTokenToHlpLiquidity">)
}
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link botHandlerABI}__ and `functionName` set to `"renounceOwnership"`.
 */
export function usePrepareBotHandlerRenounceOwnership(
  config: Omit<
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link botHandlerABI}__ and `functionName` set to `"setMultipleMarketStatus"`.
 */
export function usePrepareBotHandlerSetMultipleMarketStatus(
  config: Omit<
    UsePrepareContractWriteConfig<typeof botHandlerABI, "setMultipleMarketStatus">,
    "abi" | "functionName"
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: "setMultipleMarketStatus",
    ...config,
  } as UsePrepareContractWriteConfig<typeof botHandlerABI, "setMultipleMarketStatus">)
}
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link botHandlerABI}__ and `functionName` set to `"updateDynamicEnabled"`.
 */
export function usePrepareBotHandlerUpdateDynamicEnabled(
  config: Omit<
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link botHandlerABI}__ and `functionName` set to `"updateLiquidityEnabled"`.
 */
export function usePrepareBotHandlerUpdateLiquidityEnabled(
  config: Omit<
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link botHandlerABI}__ and `functionName` set to `"withdrawFundingFeeSurplus"`.
 */
export function usePrepareBotHandlerWithdrawFundingFeeSurplus(
  config: Omit<
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link botHandlerABI}__ and `eventName` set to `"LogCloseDelistedMarketPositions"`.
 */
export function useBotHandlerLogCloseDelistedMarketPositionsEvent(
  config: Omit<
    UseContractEventConfig<typeof botHandlerABI, "LogCloseDelistedMarketPositions">,
    "abi" | "eventName"
  > = {} as any,
) {
  return useContractEvent({
    abi: botHandlerABI,
    eventName: "LogCloseDelistedMarketPositions",
    ...config,
  } as UseContractEventConfig<typeof botHandlerABI, "LogCloseDelistedMarketPositions">)
}
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link botHandlerABI}__ and `eventName` set to `"LogDeleverages"`.
 */
export function useBotHandlerLogDeleveragesEvent(
  config: Omit<UseContractEventConfig<typeof botHandlerABI, "LogDeleverages">, "abi" | "eventName"> = {} as any,
) {
  return useContractEvent({ abi: botHandlerABI, eventName: "LogDeleverages", ...config } as UseContractEventConfig<
    typeof botHandlerABI,
    "LogDeleverages"
  >)
}
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link botHandlerABI}__ and `eventName` set to `"LogInjectTokenToHlpLiquidity"`.
 */
export function useBotHandlerLogInjectTokenToHlpLiquidityEvent(
  config: Omit<
    UseContractEventConfig<typeof botHandlerABI, "LogInjectTokenToHlpLiquidity">,
    "abi" | "eventName"
  > = {} as any,
) {
  return useContractEvent({
    abi: botHandlerABI,
    eventName: "LogInjectTokenToHlpLiquidity",
    ...config,
  } as UseContractEventConfig<typeof botHandlerABI, "LogInjectTokenToHlpLiquidity">)
}
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link botHandlerABI}__ and `eventName` set to `"LogSetMultipleMarketStatus"`.
 */
export function useBotHandlerLogSetMultipleMarketStatusEvent(
  config: Omit<
    UseContractEventConfig<typeof botHandlerABI, "LogSetMultipleMarketStatus">,
    "abi" | "eventName"
  > = {} as any,
) {
  return useContractEvent({
    abi: botHandlerABI,
    eventName: "LogSetMultipleMarketStatus",
    ...config,
  } as UseContractEventConfig<typeof botHandlerABI, "LogSetMultipleMarketStatus">)
}
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link botHandlerABI}__ and `eventName` set to `"LogUpdateLiquidityEnabled"`.
 */
export function useBotHandlerLogUpdateLiquidityEnabledEvent(
  config: Omit<
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link ecoPythABI}__ and `functionName` set to `"initialize"`.
 */
export function useEcoPythInitialize<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof ecoPythABI, "initialize">["abi"],
        "initialize"
      > & { functionName?: "initialize" }
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link ecoPythABI}__ and `functionName` set to `"renounceOwnership"`.
 */
export function useEcoPythRenounceOwnership<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof ecoPythABI, "renounceOwnership">["abi"],
        "renounceOwnership"
      > & { functionName?: "renounceOwnership" }
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link ecoPythABI}__ and `functionName` set to `"setAssetId"`.
 */
export function useEcoPythSetAssetId<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof ecoPythABI, "setAssetId">["abi"],
        "setAssetId"
      > & { functionName?: "setAssetId" }
    : UseContractWriteConfig<TMode, typeof ecoPythABI, "setAssetId"> & {
        abi?: never
        functionName?: "setAssetId"
      } = {} as any,
) {
  return useContractWrite<TMode, typeof ecoPythABI, "setAssetId">({
    abi: ecoPythABI,
    functionName: "setAssetId",
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link ecoPythABI}__ and `functionName` set to `"setUpdaters"`.
 */
export function useEcoPythSetUpdaters<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof ecoPythABI, "setUpdaters">["abi"],
        "setUpdaters"
      > & { functionName?: "setUpdaters" }
    : UseContractWriteConfig<TMode, typeof ecoPythABI, "setUpdaters"> & {
        abi?: never
        functionName?: "setUpdaters"
      } = {} as any,
) {
  return useContractWrite<TMode, typeof ecoPythABI, "setUpdaters">({
    abi: ecoPythABI,
    functionName: "setUpdaters",
    ...config,
  } as any)
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link ecoPythABI}__ and `functionName` set to `"renounceOwnership"`.
 */
export function usePrepareEcoPythRenounceOwnership(
  config: Omit<
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link ecoPythABI}__ and `functionName` set to `"setAssetId"`.
 */
export function usePrepareEcoPythSetAssetId(
  config: Omit<UsePrepareContractWriteConfig<typeof ecoPythABI, "setAssetId">, "abi" | "functionName"> = {} as any,
) {
  return usePrepareContractWrite({
    abi: ecoPythABI,
    functionName: "setAssetId",
    ...config,
  } as UsePrepareContractWriteConfig<typeof ecoPythABI, "setAssetId">)
}
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link ecoPythABI}__ and `functionName` set to `"setUpdaters"`.
 */
export function usePrepareEcoPythSetUpdaters(
  config: Omit<UsePrepareContractWriteConfig<typeof ecoPythABI, "setUpdaters">, "abi" | "functionName"> = {} as any,
) {
  return usePrepareContractWrite({
    abi: ecoPythABI,
    functionName: "setUpdaters",
    ...config,
  } as UsePrepareContractWriteConfig<typeof ecoPythABI, "setUpdaters">)
}
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link ecoPythABI}__ and `eventName` set to `"SetAssetId"`.
 */
export function useEcoPythSetAssetIdEvent(
  config: Omit<UseContractEventConfig<typeof ecoPythABI, "SetAssetId">, "abi" | "eventName"> = {} as any,
) {
  return useContractEvent({ abi: ecoPythABI, eventName: "SetAssetId", ...config } as UseContractEventConfig<
    typeof ecoPythABI,
    "SetAssetId"
  >)
}
...
/**
 * Wraps __{@link useContract}__ with `abi` set to __{@link ecoPythCalldataBuilderABI}__.
 */
export function useEcoPythCalldataBuilder(config: Omit<UseContractConfig, "abi"> = {} as any) {
  return useContract({ abi: ecoPythCalldataBuilderABI, ...config })
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link ecoPythCalldataBuilderABI}__.
 */
export function useEcoPythCalldataBuilderRead<
  TFunctionName extends string,
  TSelectData = ReadContractResult<typeof ecoPythCalldataBuilderABI, TFunctionName>,
>(
  config: Omit<UseContractReadConfig<typeof ecoPythCalldataBuilderABI, TFunctionName, TSelectData>, "abi"> = {} as any,
) {
  return useContractRead({ abi: ecoPythCalldataBuilderABI, ...config } as UseContractReadConfig<
    typeof ecoPythCalldataBuilderABI,
    TFunctionName,
    TSelectData
  >)
}
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link ecoPythCalldataBuilderABI}__ and `functionName` set to `"build"`.
 */
export function useEcoPythCalldataBuilderBuild<
  TSelectData = ReadContractResult<typeof ecoPythCalldataBuilderABI, "build">,
>(
  config: Omit<
    UseContractReadConfig<typeof ecoPythCalldataBuilderABI, "build", TSelectData>,
    "abi" | "functionName"
  > = {} as any,
) {
  return useContractRead({ abi: ecoPythCalldataBuilderABI, functionName: "build", ...config } as UseContractReadConfig<
    typeof ecoPythCalldataBuilderABI,
    "build",
    TSelectData
  >)
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link ecoPythCalldataBuilderABI}__ and `functionName` set to `"ecoPyth"`.
 */
export function useEcoPythCalldataBuilderEcoPyth<
  TSelectData = ReadContractResult<typeof ecoPythCalldataBuilderABI, "ecoPyth">,
>(
  config: Omit<
    UseContractReadConfig<typeof ecoPythCalldataBuilderABI, "ecoPyth", TSelectData>,
    "abi" | "functionName"
  > = {} as any,
) {
  return useContractRead({
    abi: ecoPythCalldataBuilderABI,
    functionName: "ecoPyth",
    ...config,
  } as UseContractReadConfig<typeof ecoPythCalldataBuilderABI, "ecoPyth", TSelectData>)
}
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link limitTradeHandlerABI}__ and `functionName` set to `"setIsAllowAllExecutor"`.
 */
export function useLimitTradeHandlerSetIsAllowAllExecutor<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof limitTradeHandlerABI, "setIsAllowAllExecutor">["abi"],
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link limitTradeHandlerABI}__ and `functionName` set to `"setIsAllowAllExecutor"`.
 */
export function usePrepareLimitTradeHandlerSetIsAllowAllExecutor(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link liquidityHandlerABI}__ and `functionName` set to `"maxExecutionChuck"`.
 */
export function useLiquidityHandlerMaxExecutionChuck<
  TSelectData = ReadContractResult<typeof liquidityHandlerABI, "maxExecutionChuck">,
>(
  config: Omit<
    UseContractReadConfig<typeof liquidityHandlerABI, "maxExecutionChuck", TSelectData>,
    "abi" | "functionName"
  > = {} as any,
) {
  return useContractRead({
    ...
    functionName: "maxExecutionChuck",
    ...config,
  } as UseContractReadConfig<typeof liquidityHandlerABI, "maxExecutionChuck", TSelectData>)
}
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link liquidityHandlerABI}__ and `functionName` set to `"setMaxExecutionChuck"`.
 */
export function useLiquidityHandlerSetMaxExecutionChuck<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof liquidityHandlerABI, "setMaxExecutionChuck">["abi"],
        "setMaxExecutionChuck"
      > & { functionName?: "setMaxExecutionChuck" }
    : UseContractWriteConfig<TMode, typeof liquidityHandlerABI, "setMaxExecutionChuck"> & {
        abi?: never
        functionName?: "setMaxExecutionChuck"
      } = {} as any,
) {
  return useContractWrite<TMode, typeof liquidityHandlerABI, "setMaxExecutionChuck">({
    abi: liquidityHandlerABI,
    functionName: "setMaxExecutionChuck",
    ...config,
  } as any)
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link liquidityHandlerABI}__ and `functionName` set to `"setMaxExecutionChuck"`.
 */
export function usePrepareLiquidityHandlerSetMaxExecutionChuck(
  config: Omit<
    UsePrepareContractWriteConfig<typeof liquidityHandlerABI, "setMaxExecutionChuck">,
    "abi" | "functionName"
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: "setMaxExecutionChuck",
    ...config,
  } as UsePrepareContractWriteConfig<typeof liquidityHandlerABI, "setMaxExecutionChuck">)
}
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link liquidityHandlerABI}__ and `eventName` set to `"LogMaxExecutionChuck"`.
 */
export function useLiquidityHandlerLogMaxExecutionChuckEvent(
  config: Omit<
    UseContractEventConfig<typeof liquidityHandlerABI, "LogMaxExecutionChuck">,
    "abi" | "eventName"
  > = {} as any,
) {
  return useContractEvent({
    ...
    eventName: "LogMaxExecutionChuck",
    ...config,
  } as UseContractEventConfig<typeof liquidityHandlerABI, "LogMaxExecutionChuck">)
}
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link marketTradeHandlerABI}__ and `functionName` set to `"initialize"`.
 */
export function useMarketTradeHandlerInitialize<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof marketTradeHandlerABI, "initialize">["abi"],
        "initialize"
      > & { functionName?: "initialize" }
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link marketTradeHandlerABI}__ and `functionName` set to `"renounceOwnership"`.
 */
export function useMarketTradeHandlerRenounceOwnership<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof marketTradeHandlerABI, "renounceOwnership">["abi"],
        "renounceOwnership"
      > & { functionName?: "renounceOwnership" }
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link marketTradeHandlerABI}__ and `functionName` set to `"initialize"`.
 */
export function usePrepareMarketTradeHandlerInitialize(
  config: Omit<
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link marketTradeHandlerABI}__ and `functionName` set to `"renounceOwnership"`.
 */
export function usePrepareMarketTradeHandlerRenounceOwnership(
  config: Omit<
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link pythAdapterABI}__ and `functionName` set to `"initialize"`.
 */
export function usePythAdapterInitialize<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof pythAdapterABI, "initialize">["abi"],
        "initialize"
      > & { functionName?: "initialize" }
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link pythAdapterABI}__ and `functionName` set to `"renounceOwnership"`.
 */
export function usePythAdapterRenounceOwnership<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof pythAdapterABI, "renounceOwnership">["abi"],
        "renounceOwnership"
      > & { functionName?: "renounceOwnership" }
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link pythAdapterABI}__ and `functionName` set to `"setConfigs"`.
 */
export function usePythAdapterSetConfigs<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof pythAdapterABI, "setConfigs">["abi"],
        "setConfigs"
      > & { functionName?: "setConfigs" }
    : UseContractWriteConfig<TMode, typeof pythAdapterABI, "setConfigs"> & {
        abi?: never
        functionName?: "setConfigs"
      } = {} as any,
) {
  return useContractWrite<TMode, typeof pythAdapterABI, "setConfigs">({
    abi: pythAdapterABI,
    functionName: "setConfigs",
    ...config,
  } as any)
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link pythAdapterABI}__ and `functionName` set to `"renounceOwnership"`.
 */
export function usePreparePythAdapterRenounceOwnership(
  config: Omit<
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link pythAdapterABI}__ and `functionName` set to `"setConfigs"`.
 */
export function usePreparePythAdapterSetConfigs(
  config: Omit<UsePrepareContractWriteConfig<typeof pythAdapterABI, "setConfigs">, "abi" | "functionName"> = {} as any,
) {
  return usePrepareContractWrite({
    abi: pythAdapterABI,
    functionName: "setConfigs",
    ...config,
  } as UsePrepareContractWriteConfig<typeof pythAdapterABI, "setConfigs">)
}
