// Generated by @wagmi/cli@0.1.14 on 4/21/2023 at 10:25:10 AM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
export const oracleMiddlewareABI = [
  {
    stateMutability: "nonpayable",
    type: "constructor",
    inputs: [{ name: "_pythAdapter", internalType: "contract IOracleAdapter", type: "address" }],
  },
  ...
  { type: "error", inputs: [], name: "IOracleMiddleware_PythPriceStale" },
  { type: "error", inputs: [], name: "Owned_NotOwner" },
  { type: "error", inputs: [], name: "Owned_NotPendingOwner" },
  {
    type: "event",
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oracleMiddlewareABI}__ and `functionName` set to `"pythAdapter"`.
 */
export function useOracleMiddlewarePythAdapter<
  TSelectData = ReadContractResult<typeof oracleMiddlewareABI, "pythAdapter">
>(
  config: Omit<
    UseContractReadConfig<typeof oracleMiddlewareABI, "pythAdapter", TSelectData>,
    "abi" | "functionName"
  > = {} as any
) {
  return useContractRead({ abi: oracleMiddlewareABI, functionName: "pythAdapter", ...config } as UseContractReadConfig<
    typeof oracleMiddlewareABI,
    "pythAdapter",
    TSelectData
  >);
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oracleMiddlewareABI}__ and `functionName` set to `"setPythAdapter"`.
 */
export function useOracleMiddlewareSetPythAdapter<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof oracleMiddlewareABI, "setPythAdapter">["abi"],
        "setPythAdapter"
      > & { functionName?: "setPythAdapter" }
    : UseContractWriteConfig<TMode, typeof oracleMiddlewareABI, "setPythAdapter"> & {
        abi?: never;
        functionName?: "setPythAdapter";
      } = {} as any
) {
  return useContractWrite<TMode, typeof oracleMiddlewareABI, "setPythAdapter">({
    abi: oracleMiddlewareABI,
    functionName: "setPythAdapter",
    ...config,
  } as any);
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oracleMiddlewareABI}__ and `functionName` set to `"setPythAdapter"`.
 */
export function usePrepareOracleMiddlewareSetPythAdapter(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oracleMiddlewareABI, "setPythAdapter">,
    "abi" | "functionName"
  > = {} as any
) {
  return usePrepareContractWrite({
    ...
    functionName: "setPythAdapter",
    ...config,
  } as UsePrepareContractWriteConfig<typeof oracleMiddlewareABI, "setPythAdapter">);
}
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link oracleMiddlewareABI}__ and `eventName` set to `"LogSetPythAdapter"`.
 */
export function useOracleMiddlewareLogSetPythAdapterEvent(
  config: Omit<UseContractEventConfig<typeof oracleMiddlewareABI, "LogSetPythAdapter">, "abi" | "eventName"> = {} as any
) {
  return useContractEvent({
    abi: oracleMiddlewareABI,
    eventName: "LogSetPythAdapter",
    ...config,
  } as UseContractEventConfig<typeof oracleMiddlewareABI, "LogSetPythAdapter">);
}
