// Generated by @wagmi/cli@0.1.14 on 6/13/2023 at 5:20:38 PM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
export const limitTradeHandlerABI = [
  ...
  },
  {
    ...
    inputs: [
      { name: "_mainAccount", internalType: "address", type: "address" },
      { name: "_eachExecutionFee", internalType: "uint256", type: "uint256" },
      {
        name: "_params",
        internalType: "struct LimitTradeHandler.CreateMultiOrderParams[]",
        type: "tuple[]",
        components: [
          { name: "subAccountId", internalType: "uint8", type: "uint8" },
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link limitTradeHandlerABI}__ and `functionName` set to `"createMultiOrders"`.
 */
export function useLimitTradeHandlerCreateMultiOrders<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof limitTradeHandlerABI, "createMultiOrders">["abi"],
        "createMultiOrders"
      > & { functionName?: "createMultiOrders" }
    : UseContractWriteConfig<TMode, typeof limitTradeHandlerABI, "createMultiOrders"> & {
        abi?: never
        functionName?: "createMultiOrders"
      } = {} as any,
) {
  return useContractWrite<TMode, typeof limitTradeHandlerABI, "createMultiOrders">({
    abi: limitTradeHandlerABI,
    functionName: "createMultiOrders",
    ...config,
  } as any)
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link limitTradeHandlerABI}__ and `functionName` set to `"createMultiOrders"`.
 */
export function usePrepareLimitTradeHandlerCreateMultiOrders(
  config: Omit<
    UsePrepareContractWriteConfig<typeof limitTradeHandlerABI, "createMultiOrders">,
    "abi" | "functionName"
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: "createMultiOrders",
    ...config,
  } as UsePrepareContractWriteConfig<typeof limitTradeHandlerABI, "createMultiOrders">)
}
