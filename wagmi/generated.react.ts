// Generated by @wagmi/cli@0.1.14 on 7/5/2023 at 11:38:01 AM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
export const mockVaultStorageABI = [
  {
    stateMutability: "view",
    type: "function",
...
/**
 * Wraps __{@link useContract}__ with `abi` set to __{@link mockVaultStorageABI}__.
 */
export function useMockVaultStorage(config: Omit<UseContractConfig, "abi"> = {} as any) {
  return useContract({ abi: mockVaultStorageABI, ...config })
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link mockVaultStorageABI}__.
 */
export function useMockVaultStorageRead<
  TFunctionName extends string,
  TSelectData = ReadContractResult<typeof mockVaultStorageABI, TFunctionName>,
>(config: Omit<UseContractReadConfig<typeof mockVaultStorageABI, TFunctionName, TSelectData>, "abi"> = {} as any) {
  return useContractRead({ abi: mockVaultStorageABI, ...config } as UseContractReadConfig<
    typeof mockVaultStorageABI,
    TFunctionName,
    TSelectData
  >)
}
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link mockVaultStorageABI}__ and `functionName` set to `"getTraderTokens"`.
 */
export function useMockVaultStorageGetTraderTokens<
  TSelectData = ReadContractResult<typeof mockVaultStorageABI, "getTraderTokens">,
>(
  config: Omit<
    UseContractReadConfig<typeof mockVaultStorageABI, "getTraderTokens", TSelectData>,
    "abi" | "functionName"
  > = {} as any,
) {
  return useContractRead({
    abi: mockVaultStorageABI,
    functionName: "getTraderTokens",
    ...config,
  } as UseContractReadConfig<typeof mockVaultStorageABI, "getTraderTokens", TSelectData>)
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link mockVaultStorageABI}__ and `functionName` set to `"hlpLiquidityDebtUSDE30"`.
 */
export function useMockVaultStorageHlpLiquidityDebtUsde30<
  TSelectData = ReadContractResult<typeof mockVaultStorageABI, "hlpLiquidityDebtUSDE30">,
>(
  config: Omit<
    UseContractReadConfig<typeof mockVaultStorageABI, "hlpLiquidityDebtUSDE30", TSelectData>,
    "abi" | "functionName"
  > = {} as any,
) {
  return useContractRead({
    ...
    ...config,
  } as UseContractReadConfig<typeof mockVaultStorageABI, "hlpLiquidityDebtUSDE30", TSelectData>)
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link mockVaultStorageABI}__ and `functionName` set to `"traderBalances"`.
 */
export function useMockVaultStorageTraderBalances<
  TSelectData = ReadContractResult<typeof mockVaultStorageABI, "traderBalances">,
>(
  config: Omit<
    UseContractReadConfig<typeof mockVaultStorageABI, "traderBalances", TSelectData>,
    "abi" | "functionName"
  > = {} as any,
) {
  return useContractRead({
    ...
    ...config,
  } as UseContractReadConfig<typeof mockVaultStorageABI, "traderBalances", TSelectData>)
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link mockVaultStorageABI}__ and `functionName` set to `"traderTokens"`.
 */
export function useMockVaultStorageTraderTokens<
  TSelectData = ReadContractResult<typeof mockVaultStorageABI, "traderTokens">,
>(
  config: Omit<
    UseContractReadConfig<typeof mockVaultStorageABI, "traderTokens", TSelectData>,
    "abi" | "functionName"
  > = {} as any,
) {
  return useContractRead({ abi: mockVaultStorageABI, functionName: "traderTokens", ...config } as UseContractReadConfig<
    typeof mockVaultStorageABI,
    "traderTokens",
    TSelectData
  >)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link mockVaultStorageABI}__.
 */
export function useMockVaultStorageWrite<TMode extends WriteContractMode, TFunctionName extends string>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof mockVaultStorageABI, string>["abi"],
        TFunctionName
      >
    : UseContractWriteConfig<TMode, typeof mockVaultStorageABI, TFunctionName> & {
        abi?: never
      } = {} as any,
) {
  return useContractWrite<TMode, typeof mockVaultStorageABI, TFunctionName>({
    abi: mockVaultStorageABI,
    ...config,
  } as any)
}
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link mockVaultStorageABI}__ and `functionName` set to `"setTraderBalance"`.
 */
export function useMockVaultStorageSetTraderBalance<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof mockVaultStorageABI, "setTraderBalance">["abi"],
        "setTraderBalance"
      > & { functionName?: "setTraderBalance" }
    : UseContractWriteConfig<TMode, typeof mockVaultStorageABI, "setTraderBalance"> & {
        abi?: never
        functionName?: "setTraderBalance"
      } = {} as any,
) {
  return useContractWrite<TMode, typeof mockVaultStorageABI, "setTraderBalance">({
    abi: mockVaultStorageABI,
    functionName: "setTraderBalance",
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link mockVaultStorageABI}__ and `functionName` set to `"setTraderTokens"`.
 */
export function useMockVaultStorageSetTraderTokens<TMode extends WriteContractMode>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof mockVaultStorageABI, "setTraderTokens">["abi"],
        "setTraderTokens"
      > & { functionName?: "setTraderTokens" }
    : UseContractWriteConfig<TMode, typeof mockVaultStorageABI, "setTraderTokens"> & {
        abi?: never
        functionName?: "setTraderTokens"
      } = {} as any,
) {
  return useContractWrite<TMode, typeof mockVaultStorageABI, "setTraderTokens">({
    abi: mockVaultStorageABI,
    functionName: "setTraderTokens",
    ...config,
  } as any)
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link mockVaultStorageABI}__.
 */
export function usePrepareMockVaultStorageWrite<TFunctionName extends string>(
  config: Omit<UsePrepareContractWriteConfig<typeof mockVaultStorageABI, TFunctionName>, "abi"> = {} as any,
) {
  return usePrepareContractWrite({ abi: mockVaultStorageABI, ...config } as UsePrepareContractWriteConfig<
    typeof mockVaultStorageABI,
    TFunctionName
  >)
}
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link mockVaultStorageABI}__ and `functionName` set to `"setTraderBalance"`.
 */
export function usePrepareMockVaultStorageSetTraderBalance(
  config: Omit<
    UsePrepareContractWriteConfig<typeof mockVaultStorageABI, "setTraderBalance">,
    "abi" | "functionName"
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: "setTraderBalance",
    ...config,
  } as UsePrepareContractWriteConfig<typeof mockVaultStorageABI, "setTraderBalance">)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link mockVaultStorageABI}__ and `functionName` set to `"setTraderTokens"`.
 */
export function usePrepareMockVaultStorageSetTraderTokens(
  config: Omit<
    UsePrepareContractWriteConfig<typeof mockVaultStorageABI, "setTraderTokens">,
    "abi" | "functionName"
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: "setTraderTokens",
    ...config,
  } as UsePrepareContractWriteConfig<typeof mockVaultStorageABI, "setTraderTokens">)
}
