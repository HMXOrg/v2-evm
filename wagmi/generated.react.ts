// Generated by @wagmi/cli@0.1.14 on 6/16/2023 at 12:28:56 PM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link liquidityHandlerABI}__ and `eventName` set to `"LogMaxExecutionChunk"`.
 */
export function useLiquidityHandlerLogMaxExecutionChunkEvent(
  config: Omit<
    UseContractEventConfig<typeof liquidityHandlerABI, "LogMaxExecutionChunk">,
    "abi" | "eventName"
  > = {} as any,
) {
  return useContractEvent({
    abi: liquidityHandlerABI,
    eventName: "LogMaxExecutionChunk",
    ...config,
  } as UseContractEventConfig<typeof liquidityHandlerABI, "LogMaxExecutionChunk">)
}
